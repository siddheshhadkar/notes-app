...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                //snackbar to undo delete operation
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Note note) {
                ...
                i.putExtra(AddEditNoteActivity.EXTRA_DESCRIPTION, note.getDesc());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK) {
            ...
            if (resultCode == RESULT_CANCELED && requestCode == ADD_NOTE_REQUEST) {
                Toast.makeText(this, "Note not Saved", Toast.LENGTH_SHORT).show();
            }else if (resultCode == RESULT_CANCELED && requestCode == EDIT_NOTE_REQUEST){
